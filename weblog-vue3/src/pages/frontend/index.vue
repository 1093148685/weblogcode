    ...
    <main class="container max-w-screen-xl mx-auto px-4 md:px-6 py-4">
        ...
        <div v-else-if="currentView === 'message-wall'">
            <div class="max-w-6xl mx-auto">
                <section class="relative grid grid-cols-[1fr_1.2fr] items-center gap-5 min-h-[250px] mb-6 p-8 border border-gray-200 rounded-xl bg-white dark:bg-gray-800 dark:border-gray-700 shadow-sm overflow-hidden">
