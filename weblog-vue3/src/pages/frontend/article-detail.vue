...
.article-detail-page {
  --article-sticky-top: 96px;
  --article-page-bg: #faf7f2;
  --article-text: #243142;
  background:
...
:deep(.article-toc) {
  ...
  z-index: 20;
  width: 290px;
  height: calc(100vh - var(--article-sticky-top) - 24px);
  max-height: calc(100vh - var(--article-sticky-top) - 24px);
  overflow-x: hidden;
  overflow-y: auto;
}
