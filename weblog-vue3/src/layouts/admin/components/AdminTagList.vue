<template>
    <!-- 左边：标签导航栏 -->
    <div class="fixed top-[64px] h-[44px] px-2 right-0 z-50 flex items-center bg-white/80 backdrop-blur-md transition-all duration-300 shadow-sm border-b border-slate-200/50" :style="{left: menuStore.menuWidth}">
