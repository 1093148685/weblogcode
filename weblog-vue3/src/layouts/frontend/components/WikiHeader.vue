                    ...
                    <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg 
                        ...
                        <li>
                            <a @click="router.push({ path: '/', query: { view: 'message-wall' } })"
                                :class="[currPath === '/' && route.query.view === 'message-wall' ? 'text-sky-600 md:border-b-2 md:border-sky-600 dark:text-sky-500 dark:md:border-sky-600' : 'text-gray-900 dark:text-gray-400']"
